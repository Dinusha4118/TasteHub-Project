...
function UserRegister() {
    ...
    const sendVerificationCode = async (email) => {
        ...
        try {
            await fetch('http://localhost:8086/sendVerificationCode', {
                method: 'POST',
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (profilePicture) {
                    ...
                    await fetch(`http://localhost:8086/user/${userId}/uploadProfilePicture`, {
                        method: 'PUT',
        ...
        <div className="register-container">
            <div className="register-content-wrapper">
                <div className="register-form-container">
                    <h1 className="register-form-title">Create your TasteHub account</h1>
